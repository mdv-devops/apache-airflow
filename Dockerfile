...
COPY instantclient-basic-linux.x64-21.8.0.0.0dbru.zip /tmp
COPY instantclient-sdk-linux.x64-21.8.0.0.0dbru.zip /tmp
RUN unzip /tmp/instantclient-basic-linux.x64-21.8.0.0.0dbru.zip -d /opt/oracle
RUN unzip /tmp/instantclient-sdk-linux.x64-21.8.0.0.0dbru.zip -d /opt/oracle
RUN mv /opt/oracle/instantclient_21_8 /opt/oracle/instantclient
